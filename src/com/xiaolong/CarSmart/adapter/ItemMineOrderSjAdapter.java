...
public class ItemMineOrderSjAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            holder.item_head = (TextView) convertView.findViewById(R.id.item_head);
...
//            `distribution_status`  '配送状态 0：未发送,1：已发送,2：部分发送',
            holder.item_head.setText(res.getString(R.string.order_no) + cell.getOrder_no());
            imageLoader.displayImage(InternetURL.INTERNAL_PIC + cell.getGoodsData().get(0).getGoods_image(), holder.item_pic, CarSmartApplication.options, animateFirstListener);
//            imageLoader.displayImage(cell.getGoodsCover(), holder.item_pic, PropertyApplication.txOptions, animateFirstListener);
            holder.item_nickname.setText(cell.getGoodsData().get(0).getName());
//           '订单状态 1生成订单,2支付订单,3取消订单,4作废订单,5完成订单',
            switch (Integer.parseInt(cell.getStatus())){
                //1已发货  2 已收货 3取消  4 发送货物
                case 1:
                    holder.item_status.setText(res.getString(R.string.order_status_one));
                    ...
                    break;
                case 2:
                    holder.item_status.setText(res.getString(R.string.order_status_two));
                    ...
                    break;
                case 3:
                    holder.item_status.setText(res.getString(R.string.order_status_three));
                    holder.button_one.setVisibility(View.GONE);
                    holder.button_two.setVisibility(View.GONE);
                    holder.button_three.setVisibility(View.GONE);
                    holder.button_four.setVisibility(View.GONE);
                    ...
                    break;
                case 4:
                    holder.item_status.setText(res.getString(R.string.order_status_four));
                    holder.button_one.setVisibility(View.GONE);
                    holder.button_two.setVisibility(View.GONE);
                    holder.button_three.setVisibility(View.GONE);
                    holder.button_four.setVisibility(View.GONE);
                    ...
                    break;
                case 5:
                    holder.item_status.setText(res.getString(R.string.order_status_five));
                    holder.button_one.setVisibility(View.GONE);
            ...
            holder.item_content.setText(cell.getAddress() + res.getString(R.string.shouhuoren) +cell.getAccept_name() +res.getString(R.string.dianhua) +cell.getMobile());
            holder.item_prices.setText(res.getString(R.string.money) +cell.getReal_amount());
            holder.item_count.setText(String.format(res.getString(R.string.item_count_adapter),cell.getOrder_amount()));
            holder.item_money.setText(String.format(res.getString(R.string.item_money_adapter), Double.valueOf(cell.getReal_amount())));

            holder.item_dateline.setText(res.getString(R.string.order_time_three)+ cell.getCreate_time());
