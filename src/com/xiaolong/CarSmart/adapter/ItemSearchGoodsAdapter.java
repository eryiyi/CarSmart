 ...
 * 查询结果 商品
 */
public class ItemSearchGoodsAdapter extends BaseAdapter {
    private ViewHolder holder;
    private List<ProSearch> lists;
    ...
    public ItemSearchGoodsAdapter(List<ProSearch> lists, Context mContect){
        this.lists = lists;
...
//            holder.item_search_cont = (TextView) convertView.findViewById(R.id.item_search_cont);
        ...
        final ProSearch cell = lists.get(position);
        if(cell != null){
