                        ...
                        if (StringUtil.isJson(s)) {
                            try {
                                ...
                                if(Integer.parseInt(code1) == 200){
                                    ...
                                    Toast.makeText(RegistActivity.this,R.string.shoujhaoyicunzai , Toast.LENGTH_SHORT).show();
                                }else if(Integer.parseInt(code1) == -1){
                                    Toast.makeText(RegistActivity.this,R.string.shoujihaono , Toast.LENGTH_SHORT).show();
                                }
                                else if(Integer.parseInt(code1) == -2){
                                    Toast.makeText(RegistActivity.this,R.string.shoujhaoyicunzai , Toast.LENGTH_SHORT).show();
                                } else if(Integer.parseInt(code1) == -3){
                                    Toast.makeText(RegistActivity.this,R.string.shoujihaonoone , Toast.LENGTH_SHORT).show();
                                }
                            }catch (Exception e){
                                e.printStackTrace();
                            }
